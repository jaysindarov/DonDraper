...
const navLinks = [
    ...
    { name: 'Gallery', route: 'generations.index', icon: 'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z' },
]
</script>
            ...
            <aside class="hidden lg:flex flex-col w-64 min-h-screen bg-gray-900/50 border-r border-white/5 fixed left-0 top-0 bottom-0">
                ...
                <div class="p-4 border-t border-white/5">
                    <Link :href="route('generations.create')"
                        class="flex items-center justify-center gap-2 w-full bg-gradient-to-r from-violet-500 to-fuchsia-600 hover:from-violet-400 hover:to-fuchsia-500 text-white font-semibold py-2.5 rounded-xl transition-all shadow-lg shadow-violet-500/25 text-sm">
